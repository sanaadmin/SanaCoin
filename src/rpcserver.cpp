...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SanaCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SanaCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SanaCoin features */
        {"sanacoin", "masternode", &masternode, true, true, false},
        {"sanacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"sanacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sanacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sanacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sanacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"sanacoin", "startmasternode", &startmasternode, true, true, false},
        {"sanacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sanacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sanacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sanacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sanacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sanacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sanacoin", "mnsync", &mnsync, true, true, false},
        {"sanacoin", "spork", &spork, true, true, false},
        {"sanacoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sanacoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sanacoind, or the -server option to sanacoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sanacoin-cli " + methodname + " " + args + "\n";
}
