...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SanaCoin Core"),
     ...
     * override -datadir in the sanacoin.conf file in the default data directory
     * (to be consistent with sanacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
