...
/** Utility functions used by the SanaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SanaCoin addresses in monospace font
...
// Parse "sanacoin:" URI into recipient object, return true on successful parsing
