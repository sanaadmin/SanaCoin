...
QFontDatabase::addApplicationFont(":/fonts/sanacoin_font");

QString windowTitle = tr("SanaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SanaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SanaCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SanaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SanaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SanaCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SanaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SanaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SanaCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SanaCoin Core help message to get a list with possible SanaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SanaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SanaCoin network", "", count));
}
...
{
    QString strTitle = tr("SanaCoin Core"); // default title
