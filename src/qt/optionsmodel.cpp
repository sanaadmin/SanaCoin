...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SANA);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePrjAmount"))
        SoftSetArg("-anonymizesanacoinamount", settings.value("nAnonymizePrjAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in sanacoin.cpp during shotdown to also remove the window positions
