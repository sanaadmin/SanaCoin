 ...
 * SanaCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& SanaCoinDevKey() const { return vSanaCoinDevKey; }
    // const std::vector<unsigned char>& SanaCoinFundKey() const { return vSanaCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vSanaCoinDevKey;
    // std::vector<unsigned char> vSanaCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
