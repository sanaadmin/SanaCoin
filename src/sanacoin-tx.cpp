...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SanaCoin Core sanacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sanacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SanaCoin transaction") + "\n" +
                               "  sanacoin-tx [options] -create [commands]   " + _("Create hex-encoded SanaCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SanaCoin transaction
