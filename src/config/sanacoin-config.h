/* src/config/sanacoin-config.h.  Generated from sanacoin-config.h.in by configure.  */
/* src/config/sanacoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SanaCoin_CONFIG_H

#define SanaCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.sanacoin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SanaCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SanaCoin Core 1.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sanacoin"
