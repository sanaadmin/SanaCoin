Contributing to SanaCoin Core
============================

The SanaCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SanaCoin Core project, and is not to be
confused with overall SanaCoin Network Protocol consensus changes.

Whether a pull request is merged into SanaCoin Core rests with the project merge
...
Patches that change SanaCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SanaCoin consensus, it must have been
...
The project leader is the release manager for each SanaCoin Core release.
