...
#   c) node1 mines 32 blocks, so now node 0 has 60001sanacoin, node 1 has 4250sanacoin, node2 has none.
#   d) node0 sends 601 sanacoin to node2, in two transactions (301 sanacoin, then 300 sanacoin).
