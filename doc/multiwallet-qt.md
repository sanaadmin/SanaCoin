...
In order to support loading of multiple wallets in sanacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sanacoin.cpp.
...
Changes to sanacoin.cpp
----------------------
sanacoin.cpp is the entry point into sanacoin-qt, and as such, will require some minor modifications to provide hooks for
