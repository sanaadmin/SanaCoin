...
RESOURCES += src/qt/sanacoin.qrc src/qt/sanacoin_locale.qrc

TRANSLATIONS += src/qt/locale/sanacoin_bg.ts \
                src/qt/locale/sanacoin_de.ts \
                src/qt/locale/sanacoin_en.ts \
                src/qt/locale/sanacoin_es.ts \
                src/qt/locale/sanacoin_fi.ts \
                src/qt/locale/sanacoin_fr.ts \
                src/qt/locale/sanacoin_it.ts \
                src/qt/locale/sanacoin_ja.ts \
                src/qt/locale/sanacoin_pl.ts \
                src/qt/locale/sanacoin_pt.ts \
                src/qt/locale/sanacoin_ru.ts \
                src/qt/locale/sanacoin_sk.ts \
                src/qt/locale/sanacoin_sv.ts \
                src/qt/locale/sanacoin_vi.ts \
                src/qt/locale/sanacoin_zh_CN.ts \
                src/qt/locale/sanacoin_zh_TW.ts
